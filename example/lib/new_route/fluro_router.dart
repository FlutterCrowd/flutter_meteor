...
import 'package:hz_router_plugin_example/new_route/tree.dart';
...
class FluroRouter {
  ...
  MaterialPageRoute<void> _notFoundRoute(
    BuildContext context,
    String path, {
    bool? maintainState,
  }) {
  ...
  RouteMatch matchRoute(
    ...
    creator(
      ...
      bool isNativeTransition =
          (transition == TransitionType.native || transition == TransitionType.nativeModal);
      ...
      if (isNativeTransition) {
        return MaterialPageRoute<dynamic>(
          ...
          maintainState: maintainState,
          builder: (BuildContext context) {
            return handler.handlerFunc(context, parameters) ?? const SizedBox.shrink();
          },
        );
