...
extension MeteorNavigator {
     ...
     * @param result 检查结果回调
     */
    public static func routeExists(routeName:String, result: @escaping ((_ exists: Bool) -> Void)) {
     ...
     * @param result 检查结果回调
     */
    public static func isRoot(routeName:String, result: @escaping ((_ isRoot: Bool) -> Void)) {
